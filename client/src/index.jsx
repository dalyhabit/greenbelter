...
const App = () => {
  ...
  return (
    <div className="react-root">
      ...
      <div id="footer">
        <p id="copyright">Copyright &copy; 2025 <a className="footer-link" name="patrick-daly-website" target="_blank" href="https://patrickdaly.us">Patrick Daly</a>. All rights reserved.</p>
      </div>
    </div>
  );
};
